...
HTML_PATH = BASE_DIR.parent / "UI_Libary_2025.html"
...
CAPTURE_PRIVACY_BANNERS = True  # Don't dismiss banners, capture them
EU_MODE = True  # Use EU locale/geolocation to trigger GDPR banners
